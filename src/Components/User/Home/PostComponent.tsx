...
const PostComponent: React.FC<IPostComponentProps> = ({
  item,
  userProfile,
}) => {
                  ...
                  <PopoverBody className="bg-gray-300 flex justify-center">
                    ...
                    >
                      <p className="text-red-500 cursor-default flex gap-3">
                        <MdOutlineReportGmailerrorred className="mt-1" /> report
                        this post
                      </p>
                    </Button>
                  </PopoverBody>
          ...
          <div className="h-16 border-b flex items-center justify-around">
            {likedUser && likedUser.includes(userId) ? (
              <div
                ...
                className="flex items-center gap-3 hover:bg-blue-50 p-3 text-blue-500 cursor-pointer"
              >
              ...
              <div
                ...
                className="flex items-center gap-3 hover:bg-blue-50 p-3 cursor-pointer"
              >
                <AiOutlineLike className=" text-xl" />
              </div>
            )}
            ...
            <div className="flex items-center bg-gray-50 h-11 w-11/12 border rounded-2xl overflow-hidden">
              <input
                ...
                className={`h-full w-full ${
                  inputHighlight ? "bg-gray-200" : "bg-gray-50"
                }  outline-none px-4`}
        ...
        <ModalContent>
          ...
          <ModalBody>
            {userScreen &&
              userDetails &&
              userDetails.length &&
              userDetails.map((userItem, index) => (
                <Link
                  to={`/user/view-user-profile/${userItem._id}`}
                  key={index}
            ...
            {postShareScreen && (
              <ShareModalContent postId={item._id} onClose={onClose} />
            )}
          </ModalBody>
        </ModalContent>
      </Modal>
