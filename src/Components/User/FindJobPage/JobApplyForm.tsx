...
import { applyJob, uploadResume } from "Api/user";
        ...
        <div>
          <form onSubmit={handleSubmit} className="max-w-lg mx-auto py-10">
            <input
              ...
              className="mb-5 mt-3 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
            />
            <input
              type="text"
              value={experience}
            ...
            />
            <label className="block mb-2 text-sm font-mediumtext-white mt-5">
              upload your resume
            </label>
            <input
              type="file"
