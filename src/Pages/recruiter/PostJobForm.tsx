import { postNewJob, uploadImg } from "Api/recruiter";
                  ...
                  >
                    ...
                    <div className="md:col-span-5">
                      ...
                      <div className="flex">
                        ...
                        />
                        <button
                          onClick={() => handleSkillAddition(skillInput)}
                      ...
                      <ul className="mt-2">
                        <div className="flex">
                          {skills.map((skill, index) => (
                            <li
                              key={index}
                              className="py-1 w-4/12 m-2 rounded-sm border border-black p-3"
                            >
                              <div className="flex">
                                <p>{skill}</p>
                                <IoIosClose
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        name="total_vaccancy"
                        value={
                          values.total_vaccancy === 0
                            ? ""
                            : values.total_vaccancy
                        }
                        onBlur={handleBlur}
                        onChange={handleChange}
                        className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                      />
                      {errors.total_vaccancy && (
                        <small className="text-red-500">
                          {errors.total_vaccancy}
                        </small>
                      )}
