...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <div className="outerdiv bg-gray-100 pt- flex flex-col justify-center items-start  md:min-h-screen sm:h-screen">
        <div className="w-lg ms-5 p-5 mt-5 sm:p-0 sm:mt-0 sm:px-2">
          <motion.h1
            ...
            animate={{ fontSize: 50, color: "yellow", y: -10 }}
          >
            DISCOVER YOUR
          </motion.h1>
          <motion.h1
          ...
          <p className="text-amber-200">
            ...
            heights and <br /> passionate about startups.
          </p>
          <div className="bg-white rounded-lg shadow-lg py-5 sm:p-6 mt-5 mb-8">
            <form className="flex flex-col sm:flex-row items-center">
              ...
              <a href="#jobsection">
                <button
                  type="button"
                  className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md transition duration-300 ml-0 sm:ml-2"
                >
                  Search Jobs
                </button>
              </a>
      ...
      <JobListingsPage jobs={jobs} setJobs={setJobs} />
      <Footer />
    </>
  );
};
