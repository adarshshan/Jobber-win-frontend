...
export interface FormDataInerface {
  name: string;
  email: string;
  phone: string;
  location: string;
    ...
    <>
      <div className="bg-white min-h-screen flex">
        <div className="w-full flex flex-row">
          <div
            className="hidden lg:flex flex-col justify-between bg-gradient-to-r from-blue-800 
          ...
          >
            ...
            <div className="space-y-5">
              <h1 className="lg:text-3xl xl:text-5xl xl:leading-snug text-white font-extrabold">
            ...
            <div className="flex flex-1 flex-col justify-center space-y-5 max-w-md">
              <div className="flex flex-col space-y-2 text-center pt-3">
                ...
                <p className="text-md md:text-xl">
                  Sign up or log in to go straight, no password required!
                </p>
              </div>
