    ...
    <>
      ...
      <div className="container mb-24">
        <div className="grid grid-cols-12 gap-2 min-h-screen shadow-lg px-4 sm:px-14 mb-5">
          <div
            className={`col-spam-12 ${
              jobs ? "hidden" : "block"
            } sm:block sm:col-span-6 min-h-50 border-r-4`}
          >
                  ...
                  jobs.map((item, index) => (
                    ...
                    >
                      <div className="flex justify-between sm:justify-start sm:gap-4 p-1 mt-3 w-full">
                        <img
                          className="w-16 h-16 rounded-md mt-3"
                          src={item.job_img}
                          alt={item.title}
                        />
                        <div>
            ...
            {job ? (
              <div className="job-details w-full">
                    ...
                    <PopoverContent>
                      ...
                      <PopoverBody className="bg-gray-300 flex justify-center">
                        <Button
                          ...
                          m={4}
                        >
                          <p className="text-red-500 cursor-default flex gap-3">
                            <MdOutlineReportGmailerrorred className="mt-1" />{" "}
                            report this job
                          </p>
                        </Button>
                      </PopoverBody>
                ...
                <div className="p-0 sm:p-5 text-sm">
                  <p className="mt-3">
                    {job.location},kerala,India <span>1 month ago</span>
                  </p>
                  <p className="mt-3">
                    5 of 10 skills match your profile- you may be good fit
                  </p>
                </div>
                <div className="flex justify-start py-5 sm:p-5 border-b-2 gap-5">
                  <button
                    onClick={() => setShowForm(true)}
                    className="rounded-full bg-blue-500 px-7 p-1 text-xl font-semibold text-white"
                  >
                    Apply
                  </button>
                  <button
                    onClick={() => handleSaveJob(job._id)}
                    className="rounded-full border border-blue-600 px-7 p-1 text-xl font-semibold text-blue-500"
                  >
                    Save
                  </button>
                </div>
                <div className="p-0 sm:p-5">
                  ...
                  <p className="mt-3">
                    ...
                    {job.min_salary} - {job.max_salary} /month (based on your
                    experience)
                  </p>
                  <p className="mt-3">
                  ...
                  <p className="mt-3">
                    <span className="font-semibold">Shift</span> : (GMT+05:30)
                    Asia/Kolkata (IST){" "}
                  </p>
                  <p className="mt-3">
                  ...
                  <p className="mt-3">
                    <span className="font-semibold">Placement type</span> : Full
                    time permenant position
                  </p>
                  <p className="mt-3">
                    <span className="font-semibold">Primary Skills</span> :
                    Mongodb,express,javascript,node,react,tailwindcss
                  </p>
                  <p className="mt-3">
                    <span className="font-semibold">requirement</span> :
                    Education: Bachelor’s degree in Computer Science, Web
